...
- Create Angular project with ng: `ng new nextech.hackernews.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`nextech.hackernews.client.esproj`).
